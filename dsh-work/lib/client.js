window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		* uses the lead whale.
		* @module dsh-work/client/artwork
		*/
		/** Artwork route prefix served by the plugin host half. */
		const ART_BASE = "/plugins/dsh-work/assets/";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/fangshoufanji/workspace/deepseek-plugins/dsh-work/src/client/AgentTeamsCard.module.css.mjs
		...
		* (historical session review). */
		...
		function AgentTeamsCard({ node, openSession, currentSessionId }) {
			...
			(0, react.useEffect)(() => {
				let cancelled = false;
				const tick = async () => {
					for (const url of ["/plugins/dsh-work/state", "/plugins/dsh-work/state?archived=1"]) try {
		...
		//#endregion
		//#region \0dsh-css:/Users/fangshoufanji/workspace/deepseek-plugins/dsh-work/src/client/ActivityPanel.module.css.mjs
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [(0, react_jsx_runtime.jsxs)("header", {
					...
					children: [(0, react_jsx_runtime.jsxs)("span", {
						...
						children: pinnedTaskId === null ? "悬停高亮依赖链 · 点击固定" : `${pinnedTaskId} 已固定 · Esc 取消`
					})]
