...
<p align="center">
  <img src="./assets/readme/hero.svg" width="100%" alt="dsh-work 把一个 DeepSeek Harness 会话变成可协作的多智能体团队">
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/dsh-work"><img src="https://img.shields.io/npm/v/dsh-work.svg" alt="npm 版本"></a>
  <a href="./LICENSE"><img src="https://img.shields.io/npm/l/dsh-work.svg" alt="MIT 许可证"></a>
  <img src="https://img.shields.io/badge/DeepSeek%20Harness-plugin-202724" alt="DeepSeek Harness 插件">
</p>

## 一句话，拉起一支真正协作的团队

`dsh-work` 让当前 DeepSeek Harness 会话成为队长：创建可续聊的子 Agent、把目标拆成有依赖的任务，并通过直达消息协调成员工作。
...
```sh
dsh plugin --profile web add dsh-work
```

### 从源码构建

```sh
git clone https://github.com/NanmiCoder/dsh-work.git
cd dsh-work
pnpm install
pnpm build
...
```sh
npx skills add NanmiCoder/dsh-work --skill dsh-plugin-development
```
