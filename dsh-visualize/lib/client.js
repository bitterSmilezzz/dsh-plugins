window.__ModuleLoader__.load({
  id: 'dsh-visualize',
  factory: (require) => {
function sub_visualize(require) {
		var module = { exports: {} };
...
@media (prefers-reduced-motion: reduce) { .dsh-viz-enter { animation: none; } }
</style>
...
function sub_visionBridge(require) {
    ...
    const parts = [
      sub_visualize(require),
      sub_visionBridge(require),
    ]
    ...
    return { name: 'dsh-visualize', inject, apply }
  },
})
